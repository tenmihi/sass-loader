...
const nodeSassAssetFunctions = require("node-sass-asset-functions");
...
function normalizeOptions(loaderContext, content, webpackImporter) {
    ...
    // embedded node-sass-asset-function
    if (options.nodeSassAssetFunctions) {
        options.functions = nodeSassAssetFunctions(options.nodeSassAssetFunctions)
    }
